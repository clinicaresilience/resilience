...
export function MobileCalendar({
  ...
  const hasAvailableSlots = agendaSlots.some(slot => slot.disponivel);
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-col justify-center h-64 items-center text-center">
            ...
            <p className="text-gray-500 text-lg font-medium">Nenhum horário disponível</p>
            <p className="text-gray-400 text-sm mt-2">Este profissional não possui horários disponíveis no momento.</p>
          </div>
        </CardContent>
      </Card>
    );
