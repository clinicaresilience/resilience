      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-4 right-4 rounded-md p-1 text-gray-400 opacity-70 transition-all hover:opacity-100 hover:bg-gray-100 hover:text-gray-600 focus:ring-2 focus:ring-azul-vivido/20 focus:outline-none disabled:pointer-events-none"
          >
