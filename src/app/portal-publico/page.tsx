...
export default function AgendamentosPublico() {
  return (
    <>
      <Navegacao />
      <div className="min-h-screen bg-gradient-to-br py-16 from-slate-50 via-[#edfffe]/40 to-[#f5b26b]/8 relative overflow-hidden font-['Red_Hat_Display']">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-sm sm:text-base md:text-center mb-16">
            ...
            <h2 className="text-sm sm:text-base md:text-5xl md:text-7xl font-black text-gray-900 mb-6 leading-tight">
              Profissionais{" "}
